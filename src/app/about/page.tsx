    ...
    <>
      ...
      <Section aria-label="Who we are">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight text-foreground">What makes us different</h2>
            <p className="text-muted leading-relaxed">
      ...
      <Section variant="muted" aria-label="Capabilities at a glance">
        <CardGrid
          eyebrow="How we help"
          ...
          items={[
            ...
            },
            {
              ...
              description:
                "Controls, evidence, and operating procedures so models and automation strengthen—not weaken—your posture.",
              href: "/what-we-do",
            },
            {
      ...
      <Section aria-label="How we engage">
        <div className="max-w-3xl space-y-6">
          <h2 className="text-2xl font-semibold tracking-tight text-foreground">How we engage</h2>
