...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <StatBand
        title="Accelerate AI Application Delivery with an Intelligent Development Platform"
        stats={[
          {
            value: "~70%",
      ...
      <Section id="difference" variant="light" aria-label="The Foundry360 difference">
        <div className="mx-auto max-w-5xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-accent">The Foundry360 difference</p>
        ...
        <div className="mt-14">
          <CardGrid
            ...
            items={[
            {
              title: "Enterprise AI development and deployment",
              description:
      ...
      <Section id="insights" variant="light" aria-label="Latest thinking">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-accent">Explore our latest thinking</p>
            <h2 className="text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">
              Insights on AI, GTM, and operating models
            </h2>
            <p className="text-lg text-muted">
              Articles aligned with the themes we publish on {site.url.replace(/^https:\/\//, "")}—updated here as this
              Next.js experience becomes your primary surface.
            </p>
          </div>
      ...
      <Section id="cta" variant="dark" aria-label="Contact call to action">
        <CTABanner
          title="Curious how Foundry360 can move your program forward?"
        ...
        <p className="mt-8 text-center text-sm text-muted">
          Prefer email?{" "}
          <Link href={`mailto:${site.email}`} className="font-medium text-accent underline-offset-2 hover:underline">
            {site.email}
          </Link>
        </p>
      </Section>
